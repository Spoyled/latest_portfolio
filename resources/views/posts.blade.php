            ...
            <div class="mb-16">
                ...
                <div class="text-left mt-6 px-4">
                    ...
                    <div class="flex flex-col space-y-2 mt-4">
                        <a href="{{ $post->additional_links }}" class="bg-blue-500 text-white font-bold py-2 px-4 w-40 rounded hover:bg-blue-700 transition-colors duration-300 ease-in-out" aria-label="Visit additional links">
                            Additional Link
                        </a>
                        <a href="{{ asset('storage/resumes/' . $post->resume) }}" class="bg-blue-500 text-white font-bold py-2 px-4 w-40 rounded hover:bg-blue-700 transition-colors duration-300 ease-in-out" aria-label="Download resume PDF">
                            Download PDF
                        </a>
                    </div>
                </div>
